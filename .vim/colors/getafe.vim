...
"
" Xterm colors used:
" LightSeaGreen 37    #00afff (Greenish blue)
" DeepSkyBlue1  39    #00afff (nice blue)
" MediumPurple4 60    #5f5f87 (gray purple)
" MediumPurple2 135   #af5fff (deep purple)
" RosyBrown     138   #af8787 [fold background]
" Grey69        145   #afafaf (brown gray) [comments]
" GreenYellow   154   #afff00 (lime yellow)
" Orange3       172   #d78700 (dark orange) [search]
" Gold3         178   #d7af00 (dark gold)
" OrangeRed1    202   #ff5f00 (orange)
" IndianRed     204   #ff5f87 (Red-pink)
" Salmon1       209   #ff875f (a bit lighter orange)
...
hi Folded          guifg=#5A7085   guibg=#FFDC00                       ctermfg=253     ctermbg=138
hi IncSearch       guifg=#F8FFF9   guibg=#FF358B                       ctermfg=172     ctermbg=15
hi LineNr          guifg=#5A7085   guibg=#000000                       ctermfg=60      ctermbg=0
hi NonText         guifg=#eeeeee   guibg=#1B1D1E                       ctermfg=7       ctermbg=234
hi Search          guifg=#F8FFF9   guibg=#FF358B                       ctermfg=15      ctermbg=172
...
hi Todo            guifg=#000000   guibg=#FFDC00    gui=bold           ctermfg=0       ctermbg=178
...
hi Comment         guifg=#5A7085                                       ctermfg=239
hi String          guifg=#AEEE00                                       ctermfg=70
hi Character       guifg=#F8FFF9   guibg=#1B1D1E   gui=none            ctermfg=15      ctermbg=234
hi Constant        guifg=#B994FF                                       ctermfg=204
hi Number          guifg=#FF6E0E                                       ctermfg=202
hi Boolean         guifg=#FF6E0E                   cterm=bold          ctermfg=131
hi Float           guifg=#FF6E0E                                       ctermfg=209

hi Identifier      guifg=#01B0F0                   cterm=bold          ctermfg=202
hi Function        guifg=#01B0F0                                       ctermfg=39
" Sort of made up
"hi Noise           guifg=#FF6E0E                                       ctermfg=202
"hi Brace           guifg=#FF6E0E                                       ctermfg=39

hi Statement       guifg=#01B0F0                                       ctermfg=39
hi Conditional     guifg=#69C3FF                                       ctermfg=135
hi Repeat          guifg=#F8FFF9   guibg=#1B1D1E   gui=none            ctermfg=135
hi Label           guifg=#AEEE00                                       ctermfg=204
hi Operator        guifg=#69C3FF                                       ctermfg=202
hi Keyword         guifg=#69C3FF                                       ctermfg=154
hi Exception       guifg=#FF0000

hi Type            guifg=#AEEE00                                       ctermfg=204
hi StorageClass    guifg=#F8FFF9   guibg=#1B1D1E   cterm=bold          ctermfg=202
hi Structure       guifg=#F8FFF9   guibg=#1B1D1E   gui=none            ctermfg=15      ctermbg=234
hi Typedef         guifg=#F8FFF9   guibg=#1B1D1E   gui=none            ctermfg=15      ctermbg=234

hi Special         guifg=#01B0F0                                       ctermfg=37
hi SpecialChar     guifg=#F8FFF9   guibg=#1B1D1E   gui=none            ctermfg=15      ctermbg=234
hi Tag             guifg=#F8FFF9   guibg=#1B1D1E   gui=none            ctermfg=15      ctermbg=234
